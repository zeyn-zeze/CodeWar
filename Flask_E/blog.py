from flask import Flask, render_template,request ,url_for,redirect,flash,session,logging
...
def secim():
    if not session.get('logged_in'):
     ...
     if request.method == 'POST':
        ...
        return render_template('secim.html', data1=data[0], data2=data[1], round=tur,resim1="static/" + data[0].lower() + ".png", resim2="static/" + data[1].lower() + ".png")
